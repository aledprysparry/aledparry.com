...
function drawIntro(ctx, W, H, S, progress) {
  ...
  // Draw headshot with glow ring, name, and role badge
...
function drawInstrAgent(ctx, W, H, S, progress, agentIdx) {
  ...
  if (nameP > 0) {
    ...
    ctx.fillText(`PLAYER ${fromRight ? "B" : "A"}`, W / 2, nameY);
    ctx.restore();
  }
